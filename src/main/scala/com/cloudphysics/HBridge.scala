package com.cloudphysics.model
...
import com.cloudphysics.utilities._

object HBridge extends Logging {

  val DEFAULT_CONF_PATH = "resources/hbase-site.xml"

  def getHbaseConfig(hbaseConfig: HBaseConfig): Configuration = {
  ...
  def withHadmin(configObject: HBaseConfig, tableName: String = null)(f: (HBaseAdmin, String) => Any) {
    val conf: Configuration = getHbaseConfig(configObject)
  ...
  def create(tableName: String, families: List[String], configObject: HBaseConfig) {
  ...
  def drop(tableName: String, configObject: HBaseConfig) {
    withHadmin(configObject, tableName) {
      (hAdmin, tableName) =>
  ...
  def recreate(tableName: String, configObject: HBaseConfig) {
    withHadmin(configObject, tableName) {
      (hAdmin, tableName) =>
  ...
  def exists(tableName: String, configObject: HBaseConfig): Boolean = {
  ...
  def disable(tableName: String, configObject: HBaseConfig) {
    withHadmin(configObject, tableName) {
      (hAdmin, tableName) =>
        hAdmin.disableTable(tableName)
    }
  ...
  def enable(tableName: String, configObject: HBaseConfig) {
    withHadmin(configObject, tableName) {
      (hAdmin, tableName) =>
  ...
  def disableWork(tableName: String, func: () => Unit, configObject: HBaseConfig) {
    withHadmin(configObject, tableName) {
      (hAdmin, tableName) =>
        hAdmin.disableTable(tableName)
        func.apply
  ...
  def list(configObject: HBaseConfig): List[String] = {
  ...
  def addColumn(tableName: String, familyName: String, configObject: HBaseConfig) {
    withHadmin(configObject) {
      (hAdmin, tableName) =>
  ...
  def deleteColumn(tableName: String, familyName: String, configObject: HBaseConfig) {
    withHadmin(configObject) {
      (hAdmin, tableName) =>
        hAdmin.disableTable(tableName)
  ...
  def withHbase(hbaseConfig: HBaseConfig, rowKey: String, dataMap: List[(String, String)], timeStamp: Long)(f: (HBridge, String, String, List[(String, String)], Long) => Unit) {

    val hbridge = new HBridge(hbaseConfig.hbasetable, HBridge.getHbaseConfig(hbaseConfig))
  ...
  def batchInsertIntoHbase(hbaseConfig: HBaseConfig)(rowKey: String, timeStamp: Long, dataMap: List[(String, String)]) {

    withHbase(hbaseConfig, rowKey, dataMap, timeStamp) {
  ...
  def insertIntoHbase(hbaseConfig: HBaseConfig)(rowKey: String, timeStamp: Long, dataMap: List[(String, String)]) {
